    ...
    <OverlayShell tone="checkout" label="Checkout" onClose={onClose}>
        ...
        <section className="flex flex-col gap-1 rounded-2xl bg-muted p-3 text-sm">
          ...
          <div className="mt-1 flex justify-between border-t border-border pt-2 font-semibold">
            <span>Payable</span>
            <span className="tabular-nums">{formatCurrency(finalPayable)}</span>
          </div>
        </section>
        ...
        >
          ...
          No payment now. You&apos;ll be asked to pay by UPI or cash as soon as the restaurant accepts your order.
        </p>
        ...
        <div className="flex gap-2">
          ...
          >
            ...
            {isPlacing ? "Placing…" : `Place order · ${formatCurrency(finalPayable)}`}
          </Button>
        </div>
      </form>
        )}
