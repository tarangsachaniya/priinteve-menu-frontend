          ...
          <TableBody>
            ...
            {restaurants.map((restaurant) => (
              <TableRow key={restaurant.id}>
                <TableCell>
                  {/* max-w lives on this inner block, not the cell: a <td>
                      treats max-width as advisory unless the table is
                      table-fixed, so the slug would go on forcing the whole
                  ...
                  <div className="flex max-w-[15rem] flex-col">
                    ...
                    <Link
                      ...
                      target="_blank"
                      className="inline-flex min-w-0 items-center gap-1 text-xs text-muted-foreground underline-offset-4 hover:underline"
                    >
                      <span className="truncate">/order/{restaurant.slug}</span>
